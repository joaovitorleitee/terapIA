...
const IconBook = (p) => <Icon {...p}><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H20v15H6.5A2.5 2.5 0 0 0 4 20.5v-15Z"/><path d="M4 20.5A2.5 2.5 0 0 1 6.5 18H20"/></Icon>;
...
export {
  ...
  IconTrash, IconCheckCircle, IconXCircle, IconChevronLeft, IconChevronRight, IconBell, IconShield, IconBarChart, IconHistory, IconBook,
};
